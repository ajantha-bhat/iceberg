...
import org.apache.iceberg.data.parquet.GenericInternalParquetWriter;
...
class GenericInternalFileWriterFactory extends BaseFileWriterFactory<StructLike> {

  GenericInternalFileWriterFactory(
      Table table,
  ...
  protected void configureDataWrite(Parquet.DataWriteBuilder builder) {
    builder.createWriterFunc(GenericInternalParquetWriter::buildWriter);
  }
  ...
  static class Builder {
    ...
    GenericInternalFileWriterFactory build() {
      ...
      return new GenericInternalFileWriterFactory(
          table,
          dataFileFormat,
          dataSchema,
          dataSortOrder,
