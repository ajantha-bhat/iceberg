...
import org.apache.iceberg.data.parquet.GenericStructParquetWriter;
import org.apache.iceberg.orc.ORC;
import org.apache.iceberg.parquet.Parquet;
import org.apache.iceberg.relocated.com.google.common.base.Preconditions;

class GenericStructFileWriterFactory extends BaseFileWriterFactory<StructLike> {

  GenericStructFileWriterFactory(
      Table table,
  ...
  protected void configureDataWrite(Parquet.DataWriteBuilder builder) {
    builder.createWriterFunc(GenericStructParquetWriter::buildWriter);
  }
  ...
  static class Builder {
    ...
    GenericStructFileWriterFactory build() {
      ...
      return new GenericStructFileWriterFactory(
          table,
          dataFileFormat,
          dataSchema,
          dataSortOrder,
