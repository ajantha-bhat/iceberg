...
public class TestRemoveSnapshots extends TableTestBase {
  ...
  private PartitionStatisticsFile writePartitionStatsFile(
    ...
    return ImmutablePartitionStatisticsFile.builder()
  ...
  private PartitionStatisticsFile reusePartitionStatsFile(
  ...
  private void commitPartitionStats(Table table, PartitionStatisticsFile statisticsFile) {
    table
