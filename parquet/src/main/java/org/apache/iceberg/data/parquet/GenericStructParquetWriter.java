...
public class GenericStructParquetWriter extends BaseParquetWriter<StructLike> {
  private static final GenericStructParquetWriter INSTANCE = new GenericStructParquetWriter();

  private GenericStructParquetWriter() {}
