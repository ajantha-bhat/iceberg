...
public class Partition implements IndexedRecord {
  ...
  public static class PartitionBuilder {
    ...
    public PartitionBuilder withPartitionData(PartitionData newPartitionData) {
      this.partitionData = newPartitionData;
      return this;
    }

    public PartitionBuilder withSpecId(int newSpecId) {
      this.specId = newSpecId;
      return this;
    }

    public PartitionBuilder withDataRecordCount(long newDataRecordCount) {
      this.dataRecordCount = newDataRecordCount;
      return this;
    }

    public PartitionBuilder withDataFileCount(int newDataFileCount) {
      this.dataFileCount = newDataFileCount;
      return this;
    }

    public PartitionBuilder withDataFileSizeInBytes(long newDataFileSizeInBytes) {
      this.dataFileSizeInBytes = newDataFileSizeInBytes;
      return this;
    }

    public PartitionBuilder withPosDeleteRecordCount(Long newPosDeleteRecordCount) {
      this.posDeleteRecordCount = newPosDeleteRecordCount;
      return this;
    }

    public PartitionBuilder withPosDeleteFileCount(Integer newPosDeleteFileCount) {
      this.posDeleteFileCount = newPosDeleteFileCount;
      return this;
    }

    public PartitionBuilder withEqDeleteRecordCount(Long newEqDeleteRecordCount) {
      this.eqDeleteRecordCount = newEqDeleteRecordCount;
      return this;
    }

    public PartitionBuilder withEqDeleteFileCount(Integer newEqDeleteFileCount) {
      this.eqDeleteFileCount = newEqDeleteFileCount;
      return this;
    }

    public PartitionBuilder withLastUpdatedAt(Long newLastUpdatedAt) {
      this.lastUpdatedAt = newLastUpdatedAt;
      return this;
    }

    public PartitionBuilder withLastUpdatedSnapshotId(Long newLastUpdatedSnapshotId) {
