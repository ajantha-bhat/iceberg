...
public class GenericInternalParquetWriter extends BaseParquetWriter<StructLike> {
  private static final GenericInternalParquetWriter INSTANCE = new GenericInternalParquetWriter();

  private GenericInternalParquetWriter() {}
  ...
  private static class RecordWriter extends StructWriter<StructLike> {
